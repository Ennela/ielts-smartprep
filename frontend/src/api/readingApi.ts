...
import type { ApiResponse, Quiz, ReadingResult, ReadingHistoryItem, SpringPage } from './types';
...
const readingApi = {
    ...
    getHistory: (page = 0, size = 10): Promise<AxiosResponse<ApiResponse<SpringPage<ReadingHistoryItem>>>> =>
